...
@interface KVPlayerGLView ()

@end

@implementation KVPlayerGLView
{
...
- (instancetype)initWithFrame:(CGRect)frame size:(CGSize)size {
    if (self = [super initWithFrame:frame]) {
        _renderer = [[KVPlayerGLRenderer_YUV alloc] init];
...
- (void)updateVertices
{
    ...
    const float width   = self.frameWidth;
    const float height  = self.frameHeight;
...
@implementation KVPlayerGLRenderer
...
@implementation KVPlayerGLRenderer_YUV
{
...
- (void)setFrame:(KVPlayerVideoFrame*)frame
{
    KVPlayerVideoFrameYUV *yuvFrame = (KVPlayerVideoFrameYUV*)frame;
